...
if (
      isset($_POST['title']) and !is_null($_POST['title'])
      and isset($_POST['cat_id']) and !is_null($_POST['cat_id'])
      and isset($_POST['body']) and !is_null($_POST['body'])
) {
      ...
      if (isset($_FILES['image']) and $_FILES['image']['name'] != '') {
            ...
            $allowedMimes = array('png', 'jpg', 'jpeg', 'gif');
                        ...
                        <section class="col-md-10 pt-3">
                              ...
                              <form action="<?= url('panel/post/edit.php?post_id=' . $_GET['post_id']) ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <section class="form-group">
                                          ...
                                          <img src="<?= asset($post->image) ?>" class="mt-2" width="200" height="100">
                                    </section>
                                    <section class="form-group">
